...
exports.connect = (function(){
            ...
            that.taskLimit.startTask(msg, function(tasks){
                ...
                progressCb = function(resp) {
                    if(progress) {
                        ...
                        if(id === rply.id) {// Filter progress for this task only.
                ...
                cb = function(reply){
                    ...
                    that.msgBus.removeListener('progress', progressCb);
                };
                ...
                timedoutCb = function(){
                    ...
                    that.msgBus.removeListener('responseReady', responseCb);
                    that.msgBus.removeListener('progress', progressCb);
                };
                ...
                that.msgBus.once('responseReady',responseCb);
                that.msgBus.on('progress', progressCb);
            });
        };
    ...
    BackgroundTask.prototype.progressTask = function(taskId, msg) {
        this.completeTask(taskId, 'PROGRESS', msg);
    };
