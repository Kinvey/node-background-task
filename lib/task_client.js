...
exports.initialize = function (options) {
  ...
  TaskClient = function (options) {
    ...
    if (options.taskKey) {
      ...
      if (options.maxTasksPerKey === 0) {
        this.maxTasksPerKey = options.maxTasksPerKey = 0;
      }
      else if (isNil(options.maxTasksPerKey)) {
        this.maxTasksPerKey = options.maxTasksPerKey = 5;
      }

      console.log('MAX TASKS per KEY: ' + options.maxTasksPerKey);
  ...
  TaskClient.prototype.addTask = function (msg, options, completionCallback, progressCallback) {
    ...
    startTheTask = function () {
      ...
      that.taskLimit.startTask(msg, function (tasks) {
        ...
        console.log('addTask result tasks: ' + tasks);
    ...
    console.log('task started. about to return');
    return id;
